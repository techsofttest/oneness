...
<?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($course->duration): ?>
        ...
        <?php if($course->expiring_soon == 0): ?>
          <a href="<?php echo e(url('admin/course/expire-status/'.$course->id.'')); ?>" onclick="return confirm('Enable expiring soon badge?')" class="btn btn-warning">Hidden</a>
        ...
        <td>
            ...
            <form action="<?php echo e(route('course.destroy', $course->id)); ?>" method="POST" class="d-inline-block">
                <?php echo csrf_field(); ?>
