    ...
    <div class="row">
      ...
      <div class="col-lg-6 d-flex coo-2">
        <div class="cou-right">
          ...
          <h3><?php echo e($home_course->duration); ?></h3>
...
<script>
    ...
    images.forEach(img => {
       ...
       <?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.apps', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\xampp\htdocs\nutrition\resources\views/index.blade.php ENDPATH**/ ?>