...
<form action="<?php echo e(route('course.update',$course->id)); ?>" method="POST" enctype="multipart/form-data" id="myForm">
...
<?php echo method_field('PUT'); ?>
                ...
                <div class="card-body">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="number" class="form-control" name="duration" value="<?php echo e($course->duration); ?>" >
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="fees" value="<?php echo e($course->fees); ?>" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="editor" class="form-control editor" style="height:150px" name="description"><?php echo $course->description; ?></textarea>
...
<h2>More Videos</h2>
    ...
    <?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $more): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="col-12 mb-4">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-6">
            <p><?php echo e($more->c_title); ?></p>
            </div>

            <div class="col-sm-4">
            <a href="<?php echo e(route('course.video.delete', ['course' => $course->id, 'videoid' => $more->id])); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            */ ?>
            ...
            <label for="" class="col-sm-2 col-form-label">Uploaded Image</label>
                ...
                <img src="<?php echo e(asset('uploads/course')); ?>/<?php echo e($course->image); ?>" width="150px" alt="No Image">
    ...
    <div class="col-sm-10">
        <input type="date" name="access_start" class="form-control"
               value="<?php echo e($course->access_start ? \Carbon\Carbon::parse($course->access_start)->format('Y-m-d') : ''); ?>">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="date" name="access_end" class="form-control"
               value="<?php echo e($course->access_end ? \Carbon\Carbon::parse($course->access_end)->format('Y-m-d'): ''); ?>">
    </div>
</div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="<?php echo e($course->meta_title); ?>">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="meta_desc" value="<?php echo e($course->meta_desc); ?>">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="meta_key" value="<?php echo e($course->meta_key); ?>">
