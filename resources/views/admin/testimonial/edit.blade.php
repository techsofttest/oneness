...
<form action="{{route('testimonial.update',$testimonial->id)}}" method="POST" enctype="multipart/form-data" id="myForm">
...
@method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="title" value="{{$testimonial->title}}" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="editor" class="form-control editor" style="height:150px" name="content">{!! $testimonial->content !!}</textarea>
            ...
            <label for="" class="col-sm-2 col-form-label">Uploaded Image</label>
                ...
                <img src="{{asset('uploads/testimonial')}}/{{$testimonial->image}}" width="150px" alt="No Image">
