...
<form action="{{route('webinar.update',$webinar->id)}}" method="POST" enctype="multipart/form-data" id="myForm">
...
@method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea id="editor" class="form-control editor" style="height:150px" name="content">{!! $webinar->content !!}</textarea>
            ...
            <label for="" class="col-sm-2 col-form-label">Uploaded Image</label>
                ...
                <img src="{{asset('uploads/webinar')}}/{{$webinar->image}}" width="150px" alt="No Image">
                ...
                <input type="file" name="image" class="" id="typ_name" onChange="Filevalidation()" >
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="{{$webinar->meta_title}}" >
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="meta_desc" value="{{$webinar->meta_desc}}" >
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="meta_key" value="{{$webinar->meta_key}}" >
