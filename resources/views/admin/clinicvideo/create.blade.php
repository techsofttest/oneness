...
<h3 class="card-title">Create Clinic Video Testimonial</h3>
...
<form action="{{route('clinicvideo.store')}}" method="POST" enctype="multipart/form-data" id="myForm">
...
<script>
    flatpickr("#access_start", {
        enableTime: true,
        dateFormat: "Y-m-d h:i K", // "K" = AM/PM
        time_24hr: false
    });
</script>
