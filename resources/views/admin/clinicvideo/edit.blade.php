...
<form action="{{route('clinicvideo.update',$clinicvideo->id)}}" method="POST" enctype="multipart/form-data" id="myForm">
...
@method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="title" value="{{$clinicvideo->title}}" required>
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="video" value="{{$clinicvideo->video}}" >
