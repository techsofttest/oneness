...
<h3 class="card-title">Edit Video Testimonial</h3>
...
<form action="{{route('videotestimonial.update',$videotestimonial->id)}}" method="POST" enctype="multipart/form-data" id="myForm">
...
@method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="title" value="{{$videotestimonial->title}}" required>
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" name="video" value="{{$videotestimonial->video}}" >
