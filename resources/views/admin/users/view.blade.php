...
<h3 class="card-title"> View User</h3>
   ...
   <form action="{{ route('users.updateStatus', $user->id) }}" method="POST">
      ...
      <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea class="form-control editor" style="height:150px" disabled>{!! $user->message !!}</textarea>
   ...
   @if(!empty($user->slip))
    <div class="form-group row mt-3">
        ...
        <div class="col-sm-10">
            <a href="{{asset('uploads/slip')}}/{{$user->slip}}" target="_blank">
                <img src="{{asset('uploads/slip')}}/{{$user->slip}}" alt="Slip Image" style="max-width: 100%; height: auto; border: 1px solid #ccc; padding: 5px;" />
            </a>
        </div>
    </div>
@endif
