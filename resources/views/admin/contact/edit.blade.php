...
<div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <textarea class="form-control" id="cat_name"  name="address" placeholder="address">{{$contact->address}}</textarea>  
                        <!-- <textarea class="form-control" id="editor"  name="address" placeholder="address">{{$contact->address}}</textarea> -->
                    </div>
                </div>
...
<!--                 
                 <div class="form-group row">
                    ...
                    <input type="text" class="form-control" name="address2" placeholder="address" value="{{$contact->address2}}" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="phone" placeholder="Phone number" value="{{$contact->phone}}" required>
                    </div>
                </div>
   ...
   <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="phone2" placeholder="Phone number" value="{{$contact->phone2}}" required>
                    </div>
                </div> -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="email" class="form-control" name="email" placeholder="Email address" value="{{$contact->email}}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="whatsapp" placeholder="Whatsapp Number" value="{{$contact->whatsapp}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="facebook" placeholder="facebook Url" value="{{$contact->facebook}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="instagram" placeholder="Instagram Url" value="{{$contact->instagram}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="youtube" placeholder="Youtube Url" value="{{$contact->youtube}}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="twitter" placeholder="Twitter Url" value="{{$contact->twitter}}">
                    </div>
                </div>
                 <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="linkedin" placeholder="Linkedin Url" value="{{$contact->linkedin}}">
                    </div>
                </div>
