...
<div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                         <!-- <textarea id="editor" class="form-control" style="height:150px" name="title"></textarea> -->
 ...
 <!-- <input type="text" name="content" class="form-control" required> -->
                     <textarea id="editor1" class="form-control" style="height:150px" name="content"></textarea> 
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Add Image (1349 x 600)</label>
