...
<div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <!--<textarea id="editor1" class="form-control" style="height:150px" name="title">{!! $banner->title !!}</textarea>-->
                    </div>
                </div>
   ...
   <input type="text" class="form-control" name="content" value="{{$banner->content}}" >
            ...
            <div class="form-group row">
                ...
                <img src="{{ asset('/uploads/banner/') }}/{{ $banner->image }}" width="200px">
            ...
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Update Image (1349 x 600)</label>

                <div class="col-sm-10">
                <input type="file" name="image" class="" onChange="Filevalidation()" id="typ_name" >
                </div>
...
@section('js')
    ...
    <script>
       ...
       alertify.alert('Banner Updated Successfully').set('basic', true);    </script>
    @endif

    @if(session()->has('error'))
    <script>
        alertify.error('Banner Updation Failed '); 
    </script>
    @endif
...
editor.plugins.get( 'FileRepository' ).createUploadAdapter = ( loader ) => {
	...
	ClassicEditor
            ...
            colors: [
                ...
                // You can also keep default colors if desired
