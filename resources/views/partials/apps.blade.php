...
<link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
	...
	<link rel="stylesheet" href="{{asset('assets/css/app.min.css')}}" />
        ...
        <link rel="stylesheet" href="{{asset('assets/css/style.min.css')}}?v1.4" />
		    <link rel="stylesheet" href="{{asset('assets/css/responsive.css')}}?v1.2" />
                ...
                @if(auth()->check())
				  <li class="menu-item-has-children login-img"><a href="javascript:void()" class="phh-bb"><img src="{{asset('assets/img/user.jpg')}}" alt=""></a>
					...
					<li><a href="{{url('my-account')}}">My Account</a></li>
					 <li><a href="{{url('course-videos')}}">Course Videos</a></li>
...
<li><a href="{{url('/testiminial')}}">Testimonials</a></li>
...
<li><a href="{{url('/contact')}}">Contact us</a></li>
			...
			<div class="copyright-wrap">
                <div class="container text-center">
                    <p class="copyright-text">Copyright <i class="fal fa-copyright"></i> 2025 <a href="{{url('/')}}">Healer Sabu Joseph</a>. All Rights Reserved.  Web Design By <a href="https://www.techsoftweb.com/" target="_blank"> Techsoft</a></p>
                </div>
            </div>
        </footer>
  ...
  <div class="modal-dialog" role="document">
	...
	<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
      <div class="modelcontainer right-panel-active" id="container">
		...
		<div class="formsec">
          <form id="loginForm" action="{{route('UserAuth')}}" method="POST">
            @csrf
		  <h2>Sign in</h2>
